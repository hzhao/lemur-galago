...
/**
 * Tupleflow-Typebuilder automatically-generated class: Adjacency.
 */
@SuppressWarnings("unused")
public final class Adjacency implements Type<Adjacency> {
    public byte[] source;
    ...
    public static final class SourceOrder implements Order<Adjacency> {
        ...
        public static final class OrderedWriterClass extends OrderedWriter< Adjacency > {
            Adjacency last = null;
        ...
        public static final class ShreddedCombiner implements ReaderSource<Adjacency>, ShreddedSource {
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<Adjacency>, ShreddedSource {
            public ShreddedProcessor processor;
    ...
    public static final class SourceDestinationOrder implements Order<Adjacency> {
        public int hash(Adjacency object) {
            int h = 0;
            h += CmpUtil.hash(object.source);
    ...
    public static final class SourceWeightOrder implements Order<Adjacency> {
        public int hash(Adjacency object) {
            int h = 0;
            h += CmpUtil.hash(object.source);
            h += CmpUtil.hash(object.weight);
            return h;
        } 
        public Comparator<Adjacency> greaterThan() {
            return new Comparator<Adjacency>() {
                public int compare(Adjacency one, Adjacency two) {
                    ...
                    do {
                        result = + CmpUtil.compare(one.source, two.source);
                        if(result != 0) break;
                        result = + CmpUtil.compare(one.weight, two.weight);
                        if(result != 0) break;
                    } while (false);
                    return -result;
                }
        ...
        public static final class OrderedWriterClass extends OrderedWriter< Adjacency > {
            ...
            public void process(Adjacency object) throws IOException {
               boolean processAll = false;
               if (processAll || last == null || 0 != CmpUtil.compare(object.source, last.source)) { processAll = true; shreddedWriter.processSource(object.source); }
               if (processAll || last == null || 0 != CmpUtil.compare(object.weight, last.weight)) { processAll = true; shreddedWriter.processWeight(object.weight); }
        ...
        public static final class ShreddedBuffer {
            ...
            public void copyUntilWeight(ShreddedBuffer other, ShreddedProcessor output) throws IOException {
                while (!isAtEnd()) {
                    if (other != null) {   
                        assert !other.isAtEnd();
                        int c = + CmpUtil.compare(getWeight(), other.getWeight());
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<Adjacency>, ShreddedSource {
            ...
            public final int compareTo(ShreddedReader other) {
                ...
                do {
                    result = + CmpUtil.compare(buffer.getSource(), otherBuffer.getSource());
                    if(result != 0) break;
                    result = + CmpUtil.compare(buffer.getWeight(), otherBuffer.getWeight());
                    if(result != 0) break;
                } while (false);                                             
        ...
        public static final class DuplicateEliminator implements ShreddedProcessor {
            ...
            public void processWeight(double weight) throws IOException {  
                if (weightProcess || CmpUtil.compare(weight, last.weight) != 0) {
                    last.weight = weight;
        ...
        public static final class TupleShredder implements Processor {
            ...
            public void process(Adjacency object) throws IOException {                                                                                                                                                   
                boolean processAll = false;
                if(last == null || CmpUtil.compare(last.source, object.source) != 0 || processAll) { processor.processSource(object.source); processAll = true; }
                if(last == null || CmpUtil.compare(last.weight, object.weight) != 0 || processAll) { processor.processWeight(object.weight); processAll = true; }
    ...
    public static final class SourceDescWeightOrder implements Order<Adjacency> {
        public int hash(Adjacency object) {
            int h = 0;
            h += CmpUtil.hash(object.source);
            h += CmpUtil.hash(object.weight);
