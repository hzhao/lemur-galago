...
/**
 * Tupleflow-Typebuilder automatically-generated class: DocumentLengthWordCount.
 */
@SuppressWarnings("unused")
public final class DocumentLengthWordCount implements Type<DocumentLengthWordCount> {
    ...
    public static final class DocumentLengthOrder implements Order<DocumentLengthWordCount> {
        public int hash(DocumentLengthWordCount object) {
            int h = 0;
            h += CmpUtil.hash(object.document);
            h += CmpUtil.hash(object.length);
            return h;
        } 
            ...
            return new Comparator<DocumentLengthWordCount>() {
                public int compare(DocumentLengthWordCount one, DocumentLengthWordCount two) {
                    ...
                    do {
                        ...
                        if(result != 0) break;
                        result = + CmpUtil.compare(one.length, two.length);
                        if(result != 0) break;
                    } while (false);
                    return -result;
                }
        ...
        public static final class OrderedWriterClass extends OrderedWriter< DocumentLengthWordCount > {
            ...
            public void process(DocumentLengthWordCount object) throws IOException {
               ...
               if (processAll || last == null || 0 != CmpUtil.compare(object.length, last.length)) { processAll = true; shreddedWriter.processLength(object.length); }
        ...
        public static final class ShreddedBuffer {
            ...
            public void copyUntilLength(ShreddedBuffer other, ShreddedProcessor output) throws IOException {
                while (!isAtEnd()) {
                    if (other != null) {   
                        assert !other.isAtEnd();
                        int c = + CmpUtil.compare(getLength(), other.getLength());
        ...
        public static final class ShreddedCombiner implements ReaderSource<DocumentLengthWordCount>, ShreddedSource {
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<DocumentLengthWordCount>, ShreddedSource {
            public ShreddedProcessor processor;
            ...
            public final int compareTo(ShreddedReader other) {
                ...
                do {
                    ...
                    if(result != 0) break;
                    result = + CmpUtil.compare(buffer.getLength(), otherBuffer.getLength());
                    if(result != 0) break;
                } while (false);                                             
        ...
        public static final class DuplicateEliminator implements ShreddedProcessor {
            ...
            public void processLength(int length) throws IOException {  
                if (lengthProcess || CmpUtil.compare(length, last.length) != 0) {
                    last.length = length;
        ...
        public static final class TupleShredder implements Processor {
            ...
            public void process(DocumentLengthWordCount object) throws IOException {                                                                                                                                                   
                ...
                if(last == null || CmpUtil.compare(last.length, object.length) != 0 || processAll) { processor.processLength(object.length); processAll = true; }
    ...
    public static final class DocumentWordOrder implements Order<DocumentLengthWordCount> {
        public int hash(DocumentLengthWordCount object) {
            int h = 0;
            h += CmpUtil.hash(object.document);
    ...
    public static final class WordDocumentOrder implements Order<DocumentLengthWordCount> {
        public int hash(DocumentLengthWordCount object) {
            int h = 0;
            h += CmpUtil.hash(object.word);
            h += CmpUtil.hash(object.document);
    ...
    public static final class DocumentOrder implements Order<DocumentLengthWordCount> {
        public int hash(DocumentLengthWordCount object) {
            int h = 0;
            h += CmpUtil.hash(object.document);
            return h;
