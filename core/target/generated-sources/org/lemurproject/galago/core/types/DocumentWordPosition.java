...
/**
 * Tupleflow-Typebuilder automatically-generated class: DocumentWordPosition.
 */
@SuppressWarnings("unused")
public final class DocumentWordPosition implements Type<DocumentWordPosition> {
    ...
    public static final class DocumentOrder implements Order<DocumentWordPosition> {
        ...
        public static final class OrderedWriterClass extends OrderedWriter< DocumentWordPosition > {
        ...
        public static final class ShreddedCombiner implements ReaderSource<DocumentWordPosition>, ShreddedSource {
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<DocumentWordPosition>, ShreddedSource {
            public ShreddedProcessor processor;
    ...
    public static final class DocumentWordPositionOrder implements Order<DocumentWordPosition> {
        public int hash(DocumentWordPosition object) {
            int h = 0;
            h += CmpUtil.hash(object.document);
