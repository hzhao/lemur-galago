...
/**
 * Tupleflow-Typebuilder automatically-generated class: DocumentWordProbability.
 */
@SuppressWarnings("unused")
public final class DocumentWordProbability implements Type<DocumentWordProbability> {
    ...
    public static final class DocumentWordOrder implements Order<DocumentWordProbability> {
        ...
        public static final class OrderedWriterClass extends OrderedWriter< DocumentWordProbability > {
        ...
        public static final class ShreddedCombiner implements ReaderSource<DocumentWordProbability>, ShreddedSource {
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<DocumentWordProbability>, ShreddedSource {
            public ShreddedProcessor processor;
    ...
    public static final class WordOrder implements Order<DocumentWordProbability> {
        public int hash(DocumentWordProbability object) {
            int h = 0;
            h += CmpUtil.hash(object.word);
            return h;
    ...
    public static final class DocumentOrder implements Order<DocumentWordProbability> {
        public int hash(DocumentWordProbability object) {
            int h = 0;
            h += CmpUtil.hash(object.document);
            return h;
