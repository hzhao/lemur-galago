...
/**
 * Tupleflow-Typebuilder automatically-generated class: HalfNumberedLink.
 */
@SuppressWarnings("unused")
public final class HalfNumberedLink implements Type<HalfNumberedLink> {
    public String src;
    public long dest; 
    ...
    public HalfNumberedLink(String src, long dest) {
        this.src = src;
        this.dest = dest;
    }  
    ...
    public static final class DestOrder implements Order<HalfNumberedLink> {
        public int hash(HalfNumberedLink object) {
            int h = 0;
            h += CmpUtil.hash(object.dest);
            return h;
        } 
        public Comparator<HalfNumberedLink> greaterThan() {
            return new Comparator<HalfNumberedLink>() {
                public int compare(HalfNumberedLink one, HalfNumberedLink two) {
                    int result = 0;
                    do {
                        result = + CmpUtil.compare(one.dest, two.dest);
                        if(result != 0) break;
                    } while (false);
                    return -result;
                }
        ...
        public static final class OrderedWriterClass extends OrderedWriter< HalfNumberedLink > {
            ...
            public void process(HalfNumberedLink object) throws IOException {
               ...
               if (processAll || last == null || 0 != CmpUtil.compare(object.dest, last.dest)) { processAll = true; shreddedWriter.processDest(object.dest); }
        ...
        public interface ShreddedProcessor extends Step, Closeable {
            public void processDest(long dest) throws IOException;
        ...
        public static final class ShreddedWriter implements ShreddedProcessor {
            ...
            public void processDest(long dest) {
                lastDest = dest;
            ...
            public final void flushDest(int pauseIndex) throws IOException {
                while (buffer.getReadIndex() < pauseIndex) {
                    ...
                    output.writeLong(buffer.getDest());
        ...
        public static final class ShreddedBuffer {
            TLongArrayList dests = new TLongArrayList();
            ...
            public void copyUntilDest(ShreddedBuffer other, ShreddedProcessor output) throws IOException {
                while (!isAtEnd()) {
                    if (other != null) {   
                        ...
                        int c = + CmpUtil.compare(getDest(), other.getDest());
        ...
        public static final class ShreddedCombiner implements ReaderSource<HalfNumberedLink>, ShreddedSource {
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<HalfNumberedLink>, ShreddedSource {
            public ShreddedProcessor processor;
            ...
            public final int compareTo(ShreddedReader other) {
                ...
                int result = 0;
                do {
                    result = + CmpUtil.compare(buffer.getDest(), otherBuffer.getDest());
                    if(result != 0) break;
                } while (false);                                             
        ...
        public static final class DuplicateEliminator implements ShreddedProcessor {
            ...
            public void processDest(long dest) throws IOException {  
                if (destProcess || CmpUtil.compare(dest, last.dest) != 0) {
                    last.dest = dest;
        ...
        public static final class TupleShredder implements Processor {
            ...
            public void process(HalfNumberedLink object) throws IOException {                                                                                                                                                   
                boolean processAll = false;
                if(last == null || CmpUtil.compare(last.dest, object.dest) != 0 || processAll) { processor.processDest(object.dest); processAll = true; }
    ...
    public static final class SrcOrder implements Order<HalfNumberedLink> {
        public int hash(HalfNumberedLink object) {
            int h = 0;
            h += CmpUtil.hash(object.src);
            return h;
        } 
        public Comparator<HalfNumberedLink> greaterThan() {
            return new Comparator<HalfNumberedLink>() {
                public int compare(HalfNumberedLink one, HalfNumberedLink two) {
                    int result = 0;
                    do {
                        result = + CmpUtil.compare(one.src, two.src);
                        if(result != 0) break;
                    } while (false);
                    return -result;
                }
        ...
        public static final class OrderedWriterClass extends OrderedWriter< HalfNumberedLink > {
            ...
            public void process(HalfNumberedLink object) throws IOException {
               boolean processAll = false;
               if (processAll || last == null || 0 != CmpUtil.compare(object.src, last.src)) { processAll = true; shreddedWriter.processSrc(object.src); }
        ...
        public interface ShreddedProcessor extends Step, Closeable {
            ...
            public void processTuple(long dest) throws IOException;
        } 
        ...
        public static final class ShreddedWriter implements ShreddedProcessor {
            ...
            public final void processTuple(long dest) throws IOException {
                if (lastFlush) {
        ...
        public static final class ShreddedBuffer {
            ...
            public void processTuple(long dest) {
                assert srcs.size() > 0;
            ...
            public void copyUntilSrc(ShreddedBuffer other, ShreddedProcessor output) throws IOException {
                while (!isAtEnd()) {
                    if (other != null) {   
                        assert !other.isAtEnd();
                        int c = + CmpUtil.compare(getSrc(), other.getSrc());
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<HalfNumberedLink>, ShreddedSource {
            ...
            public final int compareTo(ShreddedReader other) {
                ...
                int result = 0;
                do {
                    result = + CmpUtil.compare(buffer.getSrc(), otherBuffer.getSrc());
                    if(result != 0) break;
                } while (false);                                             
        ...
        public static final class DuplicateEliminator implements ShreddedProcessor {
            ...
            public void processSrc(String src) throws IOException {  
                if (srcProcess || CmpUtil.compare(src, last.src) != 0) {
                    last.src = src;
        ...
        public static final class TupleShredder implements Processor {
            ...
            public void process(HalfNumberedLink object) throws IOException {                                                                                                                                                   
                boolean processAll = false;
                if(last == null || CmpUtil.compare(last.src, object.src) != 0 || processAll) { processor.processSrc(object.src); processAll = true; }
