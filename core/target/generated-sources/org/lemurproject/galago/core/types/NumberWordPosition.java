...
/**
 * Tupleflow-Typebuilder automatically-generated class: NumberWordPosition.
 */
@SuppressWarnings("unused")
public final class NumberWordPosition implements Type<NumberWordPosition> {
    ...
    public NumberWordPosition(long document, byte[] word, int position) {
    ...
    public static final class WordDocumentPositionOrder implements Order<NumberWordPosition> {
        ...
        public static final class OrderedWriterClass extends OrderedWriter< NumberWordPosition > {
        ...
        public static final class ShreddedCombiner implements ReaderSource<NumberWordPosition>, ShreddedSource {
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<NumberWordPosition>, ShreddedSource {
            public ShreddedProcessor processor;
    ...
    public static final class DocumentPositionOrder implements Order<NumberWordPosition> {
        public int hash(NumberWordPosition object) {
            int h = 0;
            h += CmpUtil.hash(object.document);
            h += CmpUtil.hash(object.position);
    ...
    public static final class WordOrder implements Order<NumberWordPosition> {
        public int hash(NumberWordPosition object) {
            int h = 0;
            h += CmpUtil.hash(object.word);
            return h;
        ...
        public interface ShreddedProcessor extends Step, Closeable {
            public void processWord(byte[] word) throws IOException;
            public void processTuple(long document, int position) throws IOException;
        } 
        ...
        public static final class ShreddedWriter implements ShreddedProcessor {
            ...
            public final void processTuple(long document, int position) throws IOException {
                if (lastFlush) {
                    if(buffer.words.size() == 0) buffer.processWord(lastWord);
                    lastFlush = false;
                }
        ...
        public static final class ShreddedBuffer {
            ...
            public void processTuple(long document, int position) {
                assert words.size() > 0;
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<NumberWordPosition>, ShreddedSource {
            ...
            public final void fill() throws IOException {
                try {   
                    ...
                    while (!buffer.isFull()) {
                        updateWord();
                        buffer.processTuple(input.readLong(), input.readInt());
                        tupleCount++;
                    }
                } catch(EOFException e) {}
            }
