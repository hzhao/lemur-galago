...
/**
 * Tupleflow-Typebuilder automatically-generated class: TextFeature.
 */
@SuppressWarnings("unused")
public final class TextFeature implements Type<TextFeature> {
    public int file;
    ...
    public static final class FeatureOrder implements Order<TextFeature> {
        public int hash(TextFeature object) {
            int h = 0;
            h += CmpUtil.hash(object.feature);
            return h;
        } 
        public Comparator<TextFeature> greaterThan() {
            return new Comparator<TextFeature>() {
                public int compare(TextFeature one, TextFeature two) {
                    int result = 0;
                    do {
                        result = + CmpUtil.compare(one.feature, two.feature);
                        if(result != 0) break;
                    } while (false);
                    return -result;
                }
        ...
        public static final class OrderedWriterClass extends OrderedWriter< TextFeature > {
            ...
            public void process(TextFeature object) throws IOException {
               ...
               if (processAll || last == null || 0 != CmpUtil.compare(object.feature, last.feature)) { processAll = true; shreddedWriter.processFeature(object.feature); }
        ...
        public static final class ShreddedBuffer {
            ArrayList<byte[]> features = new ArrayList<byte[]>();
            ...
            public void copyUntilFeature(ShreddedBuffer other, ShreddedProcessor output) throws IOException {
                while (!isAtEnd()) {
                    if (other != null) {   
                        ...
                        int c = + CmpUtil.compare(getFeature(), other.getFeature());
        ...
        public static final class ShreddedCombiner implements ReaderSource<TextFeature>, ShreddedSource {
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<TextFeature>, ShreddedSource {
            public ShreddedProcessor processor;
            ...
            public final int compareTo(ShreddedReader other) {
                ...
                int result = 0;
                do {
                    result = + CmpUtil.compare(buffer.getFeature(), otherBuffer.getFeature());
                    if(result != 0) break;
                } while (false);                                             
        ...
        public static final class DuplicateEliminator implements ShreddedProcessor {
            ...
            public void processFeature(byte[] feature) throws IOException {  
                if (featureProcess || CmpUtil.compare(feature, last.feature) != 0) {
        ...
        public static final class TupleShredder implements Processor {
            ...
            public void process(TextFeature object) throws IOException {                                                                                                                                                   
                boolean processAll = false;
                if(last == null || CmpUtil.compare(last.feature, object.feature) != 0 || processAll) { processor.processFeature(object.feature); processAll = true; }
    ...
    public static final class FileFilePositionOrder implements Order<TextFeature> {
        public int hash(TextFeature object) {
            int h = 0;
            h += CmpUtil.hash(object.file);
            h += CmpUtil.hash(object.filePosition);
            return h;
        } 
        public Comparator<TextFeature> greaterThan() {
            return new Comparator<TextFeature>() {
                public int compare(TextFeature one, TextFeature two) {
                    int result = 0;
                    do {
                        result = + CmpUtil.compare(one.file, two.file);
                        if(result != 0) break;
                        result = + CmpUtil.compare(one.filePosition, two.filePosition);
                        if(result != 0) break;
                    } while (false);
                    return -result;
                }
        ...
        public static final class OrderedWriterClass extends OrderedWriter< TextFeature > {
            ...
            public void process(TextFeature object) throws IOException {
               boolean processAll = false;
               if (processAll || last == null || 0 != CmpUtil.compare(object.file, last.file)) { processAll = true; shreddedWriter.processFile(object.file); }
               if (processAll || last == null || 0 != CmpUtil.compare(object.filePosition, last.filePosition)) { processAll = true; shreddedWriter.processFilePosition(object.filePosition); }
        ...
        public static final class ShreddedBuffer {
            ...
            public void copyUntilFile(ShreddedBuffer other, ShreddedProcessor output) throws IOException {
                while (!isAtEnd()) {
                    if (other != null) {   
                        assert !other.isAtEnd();
                        int c = + CmpUtil.compare(getFile(), other.getFile());
            ...
            public void copyUntilFilePosition(ShreddedBuffer other, ShreddedProcessor output) throws IOException {
                while (!isAtEnd()) {
                    if (other != null) {   
                        assert !other.isAtEnd();
                        int c = + CmpUtil.compare(getFilePosition(), other.getFilePosition());
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<TextFeature>, ShreddedSource {
            ...
            public final int compareTo(ShreddedReader other) {
                ...
                int result = 0;
                do {
                    result = + CmpUtil.compare(buffer.getFile(), otherBuffer.getFile());
                    if(result != 0) break;
                    result = + CmpUtil.compare(buffer.getFilePosition(), otherBuffer.getFilePosition());
                    if(result != 0) break;
                } while (false);                                             
        ...
        public static final class DuplicateEliminator implements ShreddedProcessor {
            ...
            public void processFile(int file) throws IOException {  
                if (fileProcess || CmpUtil.compare(file, last.file) != 0) {
                    last.file = file;
            ...
            public void processFilePosition(long filePosition) throws IOException {  
                if (filePositionProcess || CmpUtil.compare(filePosition, last.filePosition) != 0) {
                    last.filePosition = filePosition;
        ...
        public static final class TupleShredder implements Processor {
            ...
            public void process(TextFeature object) throws IOException {                                                                                                                                                   
                boolean processAll = false;
                if(last == null || CmpUtil.compare(last.file, object.file) != 0 || processAll) { processor.processFile(object.file); processAll = true; }
                if(last == null || CmpUtil.compare(last.filePosition, object.filePosition) != 0 || processAll) { processor.processFilePosition(object.filePosition); processAll = true; }
    ...
    public static final class FileOrder implements Order<TextFeature> {
        public int hash(TextFeature object) {
            int h = 0;
            h += CmpUtil.hash(object.file);
            return h;
