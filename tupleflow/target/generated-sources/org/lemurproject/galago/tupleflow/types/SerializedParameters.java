...
/**
 * Tupleflow-Typebuilder automatically-generated class: SerializedParameters.
 */
@SuppressWarnings("unused")
public final class SerializedParameters implements Type<SerializedParameters> {
    ...
    public static final class ParametersOrder implements Order<SerializedParameters> {
        public int hash(SerializedParameters object) {
            int h = 0;
            h += CmpUtil.hash(object.parameters);
            return h;
        } 
        public Comparator<SerializedParameters> greaterThan() {
            return new Comparator<SerializedParameters>() {
                public int compare(SerializedParameters one, SerializedParameters two) {
                    int result = 0;
                    do {
                        result = + CmpUtil.compare(one.parameters, two.parameters);
                        if(result != 0) break;
                    } while (false);
                    return -result;
                }
        ...
        public static final class OrderedWriterClass extends OrderedWriter< SerializedParameters > {
            ...
            public void process(SerializedParameters object) throws IOException {
               ...
               if (processAll || last == null || 0 != CmpUtil.compare(object.parameters, last.parameters)) { processAll = true; shreddedWriter.processParameters(object.parameters); }
        ...
        public static final class ShreddedBuffer {
            ArrayList<String> parameterss = new ArrayList<String>();
            ...
            public void copyUntilParameters(ShreddedBuffer other, ShreddedProcessor output) throws IOException {
                while (!isAtEnd()) {
                    if (other != null) {   
                        ...
                        int c = + CmpUtil.compare(getParameters(), other.getParameters());
        ...
        public static final class ShreddedCombiner implements ReaderSource<SerializedParameters>, ShreddedSource {
        ...
        public static final class ShreddedReader implements Step, Comparable<ShreddedReader>, TypeReader<SerializedParameters>, ShreddedSource {
            public ShreddedProcessor processor;
            ...
            public final int compareTo(ShreddedReader other) {
                ...
                int result = 0;
                do {
                    result = + CmpUtil.compare(buffer.getParameters(), otherBuffer.getParameters());
                    if(result != 0) break;
                } while (false);                                             
        ...
        public static final class DuplicateEliminator implements ShreddedProcessor {
            ...
            public void processParameters(String parameters) throws IOException {  
                if (parametersProcess || CmpUtil.compare(parameters, last.parameters) != 0) {
        ...
        public static final class TupleShredder implements Processor {
            ...
            public void process(SerializedParameters object) throws IOException {                                                                                                                                                   
                boolean processAll = false;
                if(last == null || CmpUtil.compare(last.parameters, object.parameters) != 0 || processAll) { processor.processParameters(object.parameters); processAll = true; }
                processor.processTuple();                                         
                last = object;
            }
